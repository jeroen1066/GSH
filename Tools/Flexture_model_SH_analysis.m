function [V] = Flexture_model_SH_analysis(Model,Elastic_thickness)
% 
...
for nlayer = 1:Model.number_of_layers
    ...
    Vlayer = Flexture_layer_SH_analysis(Model.nmax,Model.geoid,Model.Re,rhoE,max_bin,U,L,R,0,Elastic_thickness);
